					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Vendor PO Maintenance",
									"targetURL": "#zuivendorpo-display"
								}
							}]
						}]
					}
						...
						"inbounds": {
							"zuivendorpo-display": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zuivendorpo",
									"url": sap.ui.require.toUrl("zuivendorpo")
								}
							}
						}
					}
